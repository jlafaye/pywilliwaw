...
# Signal fired when a new temperature sensor is discovered.
# Payload: (sensor: TemperatureSensor, coordinator: WilliwawCoordinator)
...
class WilliwawCoordinator:
    ...
    async def async_connect(self) -> None:
        ...
        self.fan = Williwaw(ble_device, on_update=self._on_device_update)
